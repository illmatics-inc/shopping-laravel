    ...
    <div class="col-sm">
        <form action="{{ route('admin.admin_users.store') }}" method="POST">
            ...
            <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="general" name="is_owner" value="0" {{ !old('is_owner') ? 'checked' : '' }}>
                <label class="form-check-label" for="general">一般</label>
            </div>
            <div class="form-check form-check-inline">
                <input type="radio" class="form-check-input" id="owner" name="is_owner" value="1" {{ old('is_owner') ? 'checked' : '' }}>
